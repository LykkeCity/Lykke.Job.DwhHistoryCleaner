...
using Lykke.Job.DwhHistoryCleaner.Settings;
using Lykke.Job.DwhHistoryCleaner.Modules;
using Lykke.Logs;
...
namespace Lykke.Job.DwhHistoryCleaner
{
    [PublicAPI]
    public class Startup
    {
        private const string ApiVersion = "v1";
        private const string ApiName = "DwhHistoryCleanerJob API";
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            try
            {
                ...
                services.AddLykkeLogging(
                    settingsManager.ConnectionString(s => s.DwhHistoryCleanerJob.Db.LogsConnString),
                    "DwhHistoryCleanerJobLog",
                ...
                builder.RegisterModule(new JobModule(appSettings.DwhHistoryCleanerJob));
